...
bool Detector::calibrate_kpts(Blade & blade, cv::Mat & img)
{
  ...
  for (auto & diff : roi_points_diff) {
    //std::cout << "=====================================================" << std::endl;
    //std::cout << "roi_points_diff = " << diff << std::endl;
    //std::cout << "fault_tolerant = " << fault_tolerant << std::endl;
    //std::cout << "fault_tolerance_ratio = " << fault_tolerance_ratio << std::endl;
...
{
  //std::cout << "blade_array_.size() = " << blade_array_.size() << std::endl;
  for (size_t i = 0; i < blade_array_.size(); ++i) {
    //std::cout << "draw_blade run====================================" << std::endl;
